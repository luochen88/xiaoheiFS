...
var (
	...
	ErrAllHierarchyIdsRequired                            = errors.New("all hierarchy ids are required")
	...
	ErrFromAtAndToAtRequired                              = errors.New("from_at and to_at are required")
	ErrFromAtMustBeBeforeToAt                             = errors.New("from_at must be before to_at")
	ErrGoodsTypeIdRequired                                = errors.New("goods_type_id required")
	ErrGoodsTypeAndRegionIdRequired                       = errors.New("goods_type_id and region_id are required")
	ErrGoodsTypeRegionAndLineIdRequired                   = errors.New("goods_type_id, region_id and line_id are required")
	...
	ErrLineIdNotBoundToAnyGoodsType                       = errors.New("line_id not bound to any goods type")
	...
	ErrTimeRangeExceedsLimit                              = errors.New("time range exceeds limit")
